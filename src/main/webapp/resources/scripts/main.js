...
var menuNav = {
    ...
    'reportes' : {'Listar' : '/admin/reportes' }
};
/**
...
/**
 * This function display reports urls
 */
		...
		success : function (data, textStatus, jqXHR){
			if (data && data['status'] === 'OK'){
				...
				for (var i in data['reports']) {
					item = data['reports'][i];
					url = getContext().concat(item.reportPath);
					icon = getContext() +"/resources/images/"+ item.format +"_ico.gif";
					var li = "<li style='display:inline; padding: 20px;'>";
					li += "<a href='"+ url +"' target='_blank'>";					
					li += "<img src='"+ icon +"' alt='icon' width='40px' height='40px' /></a>";
					$("#reportUl").append(li);					
				}	
				$("#reportsDiv").show("slow");
			}
		},
